...
sim_re_base1, v1 = simulation('no mobile', v0, t_3min)
sim_re_train1, v2 = simulation('no mobile', v1, t_9min)
sim_re_extinction1, v3 = simulation('no mobile', v2, t_3min)

sim_re_interval1, v4 = simulation('no mobile', v3, t_1day)

sim_re_base2, v5 = simulation('no mobile', v4, t_3min)
sim_re_train2, v6 = simulation('no mobile', v5, t_9min)
sim_re_extinction2, v7 = simulation('no mobile', v6, t_3min)
