...
fig = plt.figure(figsize=(11, 5))
time = [1, 2, 3, 4, 5, 7, 8, 14, 28]
plt.plot(time, v8m, c='black', label='$u_{mem}$ original', marker='o')
plt.plot(time, v8u, c='black', linestyle='--', label='$\it{u}$ original', marker='o')
time = [14, 16, 19, 22, 28]
plt.plot(time, v10m, c='red', label='$u_{mem}$ reactivated', marker='o')
plt.plot(time, v10u, c='red', linestyle='--', label='$\it{u}$ reactivated', marker='o')
...
plt.subplot(231)
plt.plot(t_30s, sim_base1[1500:2000, 0], label='x: limb')
plt.plot(t_30s, sim_base1[1500:2000, 2], label='y: mobile')
